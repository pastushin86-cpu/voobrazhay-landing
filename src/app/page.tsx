    ...
    <div className="min-h-screen bg-gradient-to-b from-[#FFF4EC] via-white to-white text-gray-900">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{
              ...
              text: "Мы превращаем ваши ответы в живую историю и создаём акварельные иллюстрации, где образы героев похожи на вас и ваших близких.",
            },{
              step: 3,
              title: "Печать и доставка",
              text: "Книгу печатаем на премиальной бумаге, упаковываем как подарок и доставляем. Остаётся только вручить и увидеть эмоции.",
            }].map((s) => (
      ...
      <section className="py-14 sm:py-20 bg-[#FFF4EC]/70">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
  "/gallery/11-1.jpg?v=3",
  GALLERY[0],
  "/gallery/22-2.jpeg?v=3"
].map((src, i) => (
              <motion.div key={i} {...fadeUp} className="relative group overflow-hidden rounded-3xl shadow-sm">
                <img 
                  src={src} 
          ...
          <div className="mt-6 text-center text-gray-700">Срок изготовления обычно 7–10 дней. Доставка по РФ.</div>
        </div>
      </section>
      ...
      <section id="order" className="py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-10">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight">Три формата. Одна история — ваша.</h2>
            <p className="mt-2 text-gray-600">Каждая книга создаётся с нуля на основе вашей истории. Так получается уникальный и персональный подарок для самых близких.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{
              ...
              features: [
                ...
                "30-35 страниц",
                "~ 15 иллюстраций",
                "один герой на иллюстрациях",
                "одна серия правок текста"
              ],
              cta: "Выбрать «Мини»",
              ...
              features: [
                ...
                "35-40 страниц",
                "~ 20 иллюстраций",
                "до трёх героев на иллюстрациях",
                "одна серия правок текста",
                "слипкейс (мягкий футляр)"
              ],
              cta: "Выбрать «Макси»",
              ...
              features: [
                "персональная история",
                "твердая обложка Soft Touch",
                "формат 21×21 см",
                "40-45 страниц",
                "~ 25 иллюстраций",
                "любое кол-во героев на иллюстрациях",
                "правки текста до согласования",
                "подарочная упаковка",
                "открытка с персональным посланием",
                "премиальный дизайн обложки"
              ],
              cta: "Выбрать «Подарочный»",
              ...
              <motion.div key={t.name} {...fadeUp}>
                <Card className="rounded-3xl border-orange-100 h-full flex flex-col">
                  ...
                  <CardContent className="text-gray-700 space-y-4 flex-1 flex flex-col">
                    ...
                    <ul className="flex-1 space-y-2 list-disc list-inside">
