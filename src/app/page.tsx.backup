        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeUp}>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-orange-700 text-sm">
              <Stars className="h-4 w-4" /> Подарок, который становится реликвией
            </div>
            <h1 className="mt-4 text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight">
              Персонализированные книги
              <span className="block text-orange-600">где главные герои — вы</span>
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[{
              ...
              text: "Вы отвечаете на несколько вопросов и загружаете фото прямо в чате.",
            },{
              step: 2,
              title: "Текст и иллюстрации",
              text: "Пишем тёплую историю и создаём иллюстрации в нежной акварельной стилистике.",
            },{
              step: 3,
              title: "Печать и доставка",
              text: "Верстаем, печатаем и доставляем. Остаётся только подарить и радоваться вместе.",
            }].map((s) => (
